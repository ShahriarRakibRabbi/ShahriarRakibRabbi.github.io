...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function loadProjects() {
    ...
    fetch("data/projects.json")
      ...
      .catch((error) => {
        ...
        projectsGrid.innerHTML =
          '<div class="error-message">Unable to load projects. Please try again later.</div>';
      });
  }
  ...
  function createProjectCard(project) {
    ...
    card.className = `project-card ${project.categories
      ...
      project.title
            ...
            <div class="project-content">
                ...
                <div class="project-links">
                    ${
                      project.demoUrl
                        ? `<a href="${project.demoUrl}" class="project-link" target="_blank" rel="noopener noreferrer"><i class="fas fa-external-link-alt"></i> Demo</a>`
                        : ""
                    }
                    ${
                      project.codeUrl
                        ? `<a href="${project.codeUrl}" class="project-link" target="_blank" rel="noopener noreferrer"><i class="fab fa-github"></i> Code</a>`
                        : ""
                    }
                    <a href="project-details.html?id=${
                      project.id
                    }" class="project-link"><i class="fas fa-info-circle"></i> Details</a>
                </div>
            </div>
        `;
    ...
    fetch("data/testimonials.json")
      ...
      .then((data) => {
        ...
        const isHomepage =
          ...
          !document.body.classList.contains("testimonials-page");
      ...
      .catch((error) => {
        ...
        testimonialsCarousel.innerHTML =
          '<div class="error-message">Unable to load testimonials. Please try again later.</div>';
      });
  }
